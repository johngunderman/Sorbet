...
public class StepEventHandler {
	...
	private void logNewVariables(ThreadReference thread, Step lastStep, Step newStep) throws AbsentInformationException {
		
		List<String> usedVariables = sourceParser.getVariables(newStep.location.sourcePath(), newStep.location.lineNumber());
	...
	private void logChangedVariables(ThreadReference thread, Step lastStep, Step newStep) {		
		for (String lastVariable : lastStep.variableValues.keySet()) {
			
			String lastValue = lastStep.variableValues.get(lastVariable);						
			String currentValue = getValue(thread, newStep.location, lastVariable);
	...
	private void logLocation(Step newStep) throws AbsentInformationException {
		logger.logLines(newStep.location.sourcePath(), newStep.location.lineNumber());
	}
	
	private void logUsedVariables(ThreadReference thread, Step newStep) throws AbsentInformationException {
